...
function random_item() {
  ...
  var randomPrimary =
    primaryGuns[Math.floor(Math.random() * primaryGuns.length)];
  ...
  var randomSecondary =
    secondaryGuns[Math.floor(Math.random() * secondaryGuns.length)];
  ...
  document.getElementById("secondary").innerHTML =
    randomSecondary.name +
    "<br>" +
    '<img  style="width:200px;"  src="' +
    randomSecondary.image +
    ' " alt="' +
    randomSecondary.name +
    '">';
  ...
  // Random Perk 1 Logic
  var randomPerk1 =
    perkCategory1[Math.floor(Math.random() * perkCategory1.length)];
  document.getElementById("perk1").innerHTML =
    randomPerk1.name +
    "<br>" +
    '<img style="width:200px;" src="' +
  ...
  // Random Perk 2 Logic
  var randomPerk2 =
    perkCategory2[Math.floor(Math.random() * perkCategory2.length)];
  document.getElementById("perk2").innerHTML =
    randomPerk2.name +
    "<br>" +
    '<img style="width:200px;" src="' +
  ...
  var randomPerk3 =
    perkCategory3[Math.floor(Math.random() * perkCategory3.length)];
  ...
  //Random Lethal Logic
  var randomLethal =
    lethalItems[Math.floor(Math.random() * lethalItems.length)];
  document.getElementById("lethal").innerHTML =
    randomLethal.name +
    "<br>" +
    '<img style="width:200px;" src="' +
  ...
  var randomTactical =
    tacticalItems[Math.floor(Math.random() * tacticalItems.length)];
  document.getElementById("tactical").innerHTML =
    randomTactical.name +
    "<br>" +
    '<img style="width:200px;" src="' +
    randomTactical.image +
    ' " alt="' +
    randomTactical.name +
    '">';
  ...
  var randomUpgrade =
    fieldUpgrades[Math.floor(Math.random() * fieldUpgrades.length)];
  document.getElementById("fieldUpgrade").innerHTML =
    randomUpgrade.name +
    "<br>" +
    '<img style="width:200px;" src="' +
  ...
  var randomWildcard = wildcards[Math.floor(Math.random() * wildcards.length)];
  document.getElementById("wildcard").innerHTML =
    randomWildcard.name +
    "<br>" +
    '<img style="width:200px;" src="' +
    randomWildcard.image +
    ' " alt="' +
    randomWildcard.name +
    '">';
